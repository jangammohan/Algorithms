...
public class StringLongestPalindromeLeet {

    public static void main(String... str){
        StringLongestPalindromeLeet leet = new StringLongestPalindromeLeet();
        System.out.println(leet.longestPalindrome("forgeeksskeegfor"));
    }
