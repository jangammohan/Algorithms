...
public class FindSafestPathGridLeetCode {
...
//        grid.add(Arrays.asList(1,0,0,0));
        ...
        FindSafestPathGridLeetCode leet = new FindSafestPathGridLeetCode();
        System.out.println( leet.maximumSafenessFactor(grid) );
    }
